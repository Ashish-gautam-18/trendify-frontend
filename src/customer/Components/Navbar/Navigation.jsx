  ...
  return (
    <div className="bg-white pb-10">
          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                            ...
                            >
                              {section.items.map((item) => (
                                <li key={item.name} className="flex">
                                  {/* Sahi Click Fixed Handler Jo Click Hone Par Drawer Band Kar Dega */}
                                  <p
                                    onClick={() =>
                                      handleCategoryClick(
                                        category,
                ...
                {/* Fixed Dynamic Authentication Flow for Mobile Drawer */}
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  {auth.user ? (
                    <div className="space-y-4">
                      ...
                      <button
                        ...
                        className="block w-full text-left font-medium text-gray-900 py-2 border-b border-gray-100"
                      >
                        {auth.user?.role === "ROLE_ADMIN"
                          ? "Admin Dashboard"
                          : "My Orders"}
      ...
      <header className="relative bg-white">
        {/* Dynamic Promotional Announcement Banner Slider */}
        {(() => {
            ...
            const interval = setInterval(() => {
              ...
              setTimeout(() => {
                setCurrentOfferIndex(
                  (prevIndex) => (prevIndex + 1) % topOffers.length,
                );
                setFade(true);
              }, 500);
            }, 4000);
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center px-11">
              ...
              <Popover.Group className="hidden lg:ml-8 lg:block lg:self-stretch z-10">
                <div className="flex h-full space-x-8 items-center">
                          ...
                          <div className="relative flex">
                            <Popover.Button
                              className={classNames(
                                isOpen
                                  ? "text-indigo-600 underline underline-offset-[8px] decoration-[2px] decoration-indigo-600"
                  ...
                  <button
                    onClick={() =>
                      alert(
                        "Trendyfy Info: Our Kids Collection is coming soon! Currently, we are launching with our premium Men's and Women's wear. Stay tuned!",
                      )
                    }
                    className="flex items-center text-sm font-bold text-gray-700 hover:text-indigo-600 tracking-wider uppercase hover:underline hover:underline-offset-[8px] hover:decoration-[2px] hover:decoration-indigo-600 transition-colors cursor-pointer focus:outline-none"
                  >
                    Kids
                  </button>
                    ...
                    <Link
                      ...
                      onClick={(e) => {
                        if (page.name === "Stores") {
                          e.preventDefault();
                          alert(
                            "Trendyfy Info: Trendyfy operates exclusively as a premium online-only e-commerce platform. We deliver globally directly to your doorstep, ensuring a seamless digital shopping experience without physical retail storefronts.",
                          );
                        }
                      }}
              ...
              <div className="ml-auto flex items-center space-x-2 sm:space-x-4">
                ...
                {/* Authentication Dynamic Handler (Desktop Text / Mobile Dynamic Avatar fallback) */}
                <div className="flex items-center">
                  {auth.user ? (
                    <div>
                      <Avatar
                    ...
                    <div className="flex items-center">
                      {/* Mobile Profile Trigger (Visible on handheld devices) */}
                      <button
                        onClick={handleOpen}
                        className="p-2 text-gray-400 hover:text-gray-500 lg:hidden focus:outline-none"
                      >
                        <svg
                          className="h-6 w-6"
                          fill="none"
                      ...
                      {/* Original Desktop Signin Button */}
                      <Button
                        onClick={handleOpen}
                        className="hidden lg:block text-sm font-bold text-gray-700 hover:text-gray-800 tracking-wider uppercase"
                      >
                        Signin
                      </Button>
                    </div>
                ...
                {/* Current Orders Pipeline Shopping Bag Meter Counter */}
                <div className="flow-root">
                  <Button
                    onClick={() => navigate("/cart")}
                    className="group -m-2 flex items-center p-2 focus:outline-none min-w-0"
                  >
                    <ShoppingBagIcon
                      className="h-6 w-6 flex-shrink-0 text-gray-400 group-hover:text-gray-500"
                      aria-hidden="true"
                    />
                    <span className="ml-1 sm:ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-800">
