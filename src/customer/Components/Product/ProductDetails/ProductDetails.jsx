        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-wrap space-x-5 justify-center">
            {[1, 2, 3, 4].map((index) => (
              <div 
                key={`thumb-${index}`} 
                onClick={() => handleSetActiveImage(customersProduct.product?.imageUrl)}
          ...
          <div className="lg:col-span-1 mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div>
              <h1 className="text-lg lg:text-xl font-semibold tracking-tight text-gray-900">{customersProduct.product?.brand}</h1>
              <h1 className="text-lg lg:text-xl tracking-tight text-gray-900 opacity-60 pt-1">{customersProduct.product?.title}</h1>
            </div>
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
              ...
              <div className="mt-10">
                ...
                <div className="mt-4 space-y-6">
                  <p className="text-sm text-gray-600">{customersProduct.product?.details || productTemplateFallback.details}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={12} md={5}>
                ...
                {["Excellent", "Very Good", "Good", "Average", "Poor"].map((label, idx) => {
                  ...
                  const barColors = ["success", "success", "warning", "success", "error"];
                  return (
                    <Box key={label} className="mb-2">
                      <Grid container justifyContent="center" alignItems="center" gap={2}>
                        <Grid item xs={3}><p className="p-0 text-sm">{label}</p></Grid>
                        <Grid item xs={6}>
                          <LinearProgress
                        ...
                        <Grid item xs={2}><p className="opacity-50 text-sm p-1">19259</p></Grid>
                      </Grid>
                    </Box>
                  );
                })}
        ...
        <section className="pt-10 px-4 mb-10">
          ...
          <div className="flex flex-wrap gap-4">
            {customersProduct?.products?.content
              ?.filter((item) => 
                item?.category?.name === customersProduct?.product?.category?.name && 
